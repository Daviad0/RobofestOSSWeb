#pragma checksum "C:\Users\djree\source\repos\RobofestOSS\RobofestOSSWeb\RobofestWTECore\Views\Team\RoundCreate.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c1fde405a83e814a546e4874890b8a87e3b8f11f"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c1fde405a83e814a546e4874890b8a87e3b8f11f", @"/Views/Team/RoundCreate.cshtml")]
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c109033a66d042ebbc1fb56ac8a79344", async() => {
            }
            );
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "bceada609d6d48be9eea11651fb6c122", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "17beeba4a3fa4237b3792632f5c7f56b", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
...
#line hidden
        ...
        chat.on(""changeTeamScores"", function (topte");
            WriteLiteral(@"n) {
        ...
        chat.on(""changeGlobalTimer"", funct");
            WriteLiteral(@"ion (minutes, seconds, message, status, score) {
        ...
        chat.on(""retrieveTeam"", function (teamnumber) {
            ...
            $(""#te");
            WriteLiteral(@"amnumberview"").val(teamnumber);
        });
        ...
        chat.on(""fieldDefaults"", function (teamids, teamnumbers, rounds, reruns, tests, valids) {
            ...
            defau");
            WriteLiteral(@"ltfields[4][2] = rounds[4];
            ...
            $(""");
            WriteLiteral(@"#f5selector"").html(""Field 5: "" + teamnumbers[4] + "" (Round "" + rounds[4] + "")"");
            ...
            if (requesttostart == true && judgelocked == false) {
                ...
                if (fieldsub > 6 || fieldsub < 1 || nan) {
                    ...
                    if (publicround == 1) {
                        ...
                        $(""#round2hidden"").attr(""checked"", fals");
            WriteLiteral(@"e);
                    } else {
                        round = 2;
        ...
        chat.on(""initFieldView"", function (field, status, score, team, connection, matchkeeper,data) {
            if (status != 5) {
                if (status == 0) {
                    $(""#quickstatusf"" + fiel");
            WriteLiteral(@"d).css(""background-color"", ""black"");
                } else if (status == 1) {
            ...
            ");
            WriteLiteral(@"        $(""#quickstatus"").css(""color"", ""tomato"");
                    $(""#fieldstatus"").html(fieldsub);
                    if (matchkeeper == true) {
 ...
 ");
        ...
        chat.start().then(function () {
            ...
            ");
            WriteLiteral(@"        $(""#judgeaccesscode"").attr(""disabled"", true);
                }
            });
  ...
  ");
            ...
            WriteLiteral(@"t("""");
                        ...
                        $(""#navbarscore"").css(""display"", ""inline"")
                        $(""");
            WriteLiteral(@"#navbarcolor"").css(""background-color"", ""black"")
                    }
            ...
            $(""#finalize"").click(function () {
                ...
                $(""#navbartext"").html");
            WriteLiteral(@"(""Does everyone agree?"")
                $(""#navbartimer"").css(""display"",""none"")
                $(""#navbarscore"").css(""display"",""none"")
            ...
            $(""#readystatus"").click(function () {
                if (lockedin == true) {
                    ...
                    $(""#nav");
            WriteLiteral(@"bartimer"").css(""display"", ""none"")
                    $(""#navbarscore"").css(""display"", ""none"")
